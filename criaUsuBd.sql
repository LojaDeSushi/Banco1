...
grant select, update on banco1.produto to 'atendente'@'localhost';
...
grant select on banco1.atendente to 'atendente'@'localhost';
...
grant select on banco1.cliente to 'cliente'@'localhost';
grant select, update on banco1.produto to 'cliente'@'localhost';
